...
const md = [
  ...
  '',
  `Price direction (n=${report.price.n}): model ${pct(report.price.modelAccuracy)}, last-3 ${pct(report.price.last3Accuracy)}, always predicting a fall ${pct(report.price.alwaysFallAccuracy)}.`,
  '',
