...
const SECTIONS: RuleSection[] = [
  ...
  },
  {
    ...
    content: [
      {
        type: 'paragraph',
        text: 'Drivers earn fantasy points from two sources: standard F1 points (top 10) plus position bonus points (all 22 positions). Every classified finisher scores!',
      },
      { type: 'heading', text: 'Race Fantasy Points' },
      {
        type: 'table',
        headers: ['Pos', 'F1', 'Bonus', 'Total'],
        rows: [
          ['1st', '25', '+22', '47'],
          ['2nd', '18', '+21', '39'],
          ['3rd', '15', '+20', '35'],
