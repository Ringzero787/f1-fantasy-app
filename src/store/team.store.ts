...
// calculateEarlyTerminationFee and estimateSaleQuote live in src/utils/saleQuote
// (pure, jest-safe — the Picker's planner imports them without pulling in this store).
