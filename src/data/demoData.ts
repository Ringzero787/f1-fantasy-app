...
export const demoMemberTeams: Record<string, {
  drivers: string[];
  constructor: string;
  starDriver: string | null;
  starConstructor: boolean;
}> = {
  // BoxBoxBox_Barry - Aggressive top-heavy strategy
  'demo-member-1': {
    drivers: ['verstappen', 'norris', 'piastri', 'tsunoda', 'bortoleto'],
    constructor: 'mclaren',
    starDriver: 'tsunoda',
    starConstructor: false,
  },
  ...
  'demo-member-3': {
    drivers: ['hamilton', 'piastri', 'perez', 'gasly', 'hulkenberg'],
    constructor: 'red_bull',
    starDriver: null,
    starConstructor: true,
  },
  // Undercut_Uma - Value picks strategy
  'demo-member-4': {
    drivers: ['norris', 'leclerc', 'antonelli', 'stroll', 'doohan'],
  ...
  'demo-member-5': {
    drivers: ['russell', 'sainz', 'albon', 'ocon', 'bearman'],
